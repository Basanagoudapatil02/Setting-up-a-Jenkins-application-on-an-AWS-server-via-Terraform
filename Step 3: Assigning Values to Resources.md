In the previous step, resource configuration files were created without assigning specific values. Since values are essential for resource creation, this step focuses on providing those values.
